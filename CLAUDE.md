...
- **Round 5 (review and challenge cycles):** an independent review of round 4 confirmed nine defects and a 3.14t chaos suite (48 lanes and 2 × 24; redirects, capfd, cache, `--setup-show`, reruns, patches) found three more; all fixed test-first (DESIGN.md "Round 5"). Chaos suite 20/20 clean; suite green on 3.12 (pytest 8.0.2, 9.1.1) and 3.14t (9.1.1).
